...
const Hero = () => {
    ...
    useGSAP(() => {
        ...
        tl.from(".hero-text-element", {
            y: 30, // Reduced distance for faster feel
            opacity: 0,
            duration: 0.8,
            stagger: 0.1,
    ...
    return (
        <section ref={container} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-bg-light pt-32 pb-20">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div ref={textRef} className="text-left space-y-8">
                    <div className="inline-block relative hero-text-element">
                        <span className="font-cursive text-5xl text-accent transform -rotate-3 inline-block mb-2">
                            Elevate your Brand
                        </span>
                    </div>

                    <h1 className="hero-text-element text-6xl md:text-7xl font-display font-bold text-primary leading-[1.1] tracking-tight">
                        Crafting Digital <br />
                        <span className="text-primary">Excellence</span>
                    </h1>

                    <p className="hero-text-element text-lg md:text-xl text-secondary max-w-xl leading-relaxed font-light">
                    ...
                    <div className="hero-text-element flex flex-wrap gap-5 pt-4">
                    ...
                    {/* Trust Indicators */}
                    <div className="hero-text-element flex flex-wrap items-center gap-8 pt-12 mt-4 opacity-90">
                ...
                <div ref={visualRef} className="relative hidden lg:block h-[700px] w-full">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 hover:scale-[1.02] transition-transform duration-500">
                        {/* The Frame (White Outline + Thin Border) */}
                        <div className="relative w-[380px] h-[520px] bg-white p-4 shadow-2xl border border-gray-900 -rotate-2 hover:rotate-0 transition-transform duration-700 ease-out">
                            ...
                            <div className="w-full h-full bg-primary relative overflow-hidden flex flex-col items-center justify-center text-center p-8">
                                ...
                                <div className="relative z-10 flex flex-col items-center justify-center h-full">
                                    ...
                                    <h3 className="text-accent text-2xl font-display tracking-[0.2em] font-light uppercase mb-6">
                                        Client Satisfaction
                                    </h3>
